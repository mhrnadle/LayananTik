    ...
    public function up(): void
    {
        Schema::create('aset', function (Blueprint $table) {
            Schema::create('aset', function (Blueprint $table) {
                ...
                $table->unsignedBigInteger('IDLokasi')->foreign('IDLokasi')->references('id')->on('lokasiaset');
                $table->unsignedBigInteger('IDKategori')->foreign('IDKategori')->references('id')->on('kategoriaset');;
