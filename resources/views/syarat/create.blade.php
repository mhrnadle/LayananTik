        ...
        <div class="row">
            <div class="col-xs-12 mb-3">
                <div class="form-group">
                    ...
                    <input type="text" name="syarat_label" class="form-control" placeholder="Label Syarat">
                </div>
            </div>
            <div class="col-xs-12 mb-3">
                <div class="form-group">
            ...
            <div class="col-xs-12 mb-3">
                <div class="form-group">
                    ...
                    <select id="syarat_kategori_id" name="syarat_kategori_id" class="form-control">
                ...
                <div class="row ps-3">
                    ...
                    @foreach($type_file as $value)
                        <div class="form-check col-md-3 col-sm-2 col-3">
                            <input class="form-check-input" type="checkbox" name="syarat_type_file[]" value="{{ $value }}" id="flexCheck{{$value}}">
