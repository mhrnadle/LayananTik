                ...
                <div class="card mb-4 mx-4">
                    <div class="card-header pb-3">
                        <div class="d-flex flex-row justify-content-end">
                            ...
                            <a id="layanan_btn" type="button" class="btn bg-gradient-dark btn-sm mb-0" href="{{ route('info-layanan.create') }}">+&nbsp; Create Info Layanan</a>
                            @endcan
                        </div>
                    </div>
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        delete_form.action = `{{ route('info-layanan.destroy', '') }}/${id}`;
