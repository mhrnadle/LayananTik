          ...
          <div class="row">
              ...
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <form role="form" method="POST" action="{{ route('login') }}">
                    ...
                    <label>Email</label>
                    <div class="mb-3">
                      <input type="email" class="form-control" name="email" id="email" placeholder="Email" value="{{old('email')}}" aria-label="Email" aria-describedby="email-addon" required autocomplete="email" autofocus>
                      @error('email')
            ...
            <div class="col-md-6">
              <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto min-vh-100 z-index-0 ms-n6" style="background-image:url('../assets/img/curved-images/curved14.jpg')"></div>
              </div>
            </div>
          </div>
        </div>
