                ...
                <div class="card mb-4 mx-4">
                    <div class="card-header pb-3">
                        <div class="d-flex flex-row justify-content-between">
                            <div>
                                <h5 class="mb-0">All Data Role</h5>
                            </div>
                            @can('role-create')
                            <a type="button" class="btn bg-gradient-dark btn-sm mb-0" href="{{ route('roles.create') }}">+&nbsp; Create Role</a>
                            @endcan
                        </div>
                    </div>
      ...
      $(function () {
        ...
        var table = $('.roles-table').DataTable({
            ...
            columns: [
                {data: 'id', name: 'No'},
                {data: 'Name', name: 'Name'},
                {data: 'guard_name', name: 'Guard Name'},
            ]
        });
